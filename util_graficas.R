...
# Tema gráfico común para todas las figuras del libro
tema_libro <- function() {
  theme_minimal(base_size = 13) +
    theme(
      ...
      plot.title = element_text(face = "bold", size = 15, color = col_azul, hjust = 0),
      plot.subtitle = element_text(size = 10.5, color = col_gris_medio, hjust = 0),
      plot.caption = element_text(size = 8.5, color = col_gris_medio),
