...
`R` · `Quarto` · `Machine Learning` · `Datos abiertos` · `GitHub Pages`
...
::: {.callout-tip title="Enfoque del libro"}
El libro combina fundamento conceptual, código reproducible en R, interpretación didáctica de resultados y visualizaciones profesionales.
:::
